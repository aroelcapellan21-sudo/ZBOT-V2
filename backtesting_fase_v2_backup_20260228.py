...
# Nueva metodologia de validacion
...
def etiquetar_tendencia_real(cierres, pos, umbral_7d, umbral_30d, velas_7d=42, velas_30d=180):
    ...
    if cambio_7d > umbral_7d and cambio_30d > umbral_30d:
        return "ALCISTA"
    elif cambio_7d < -umbral_7d and cambio_30d < -umbral_30d:
        return "BAJISTA"
    else:
        return "LATERAL"
...
def main():
    print("="*55)
    print("BACKTESTING DETECTOR DE FASE V2")
    print("Metodologia: Umbrales especificos por activo")
