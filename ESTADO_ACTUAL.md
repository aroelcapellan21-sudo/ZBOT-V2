...
|---|---|---|
| 15-09 | *(proyecto separado, `~/deriv-test/`)* EURUSD revierte tras un movimiento brusco (±0,2% en 60 min) | 🟡 Prometedor, **no se opera nada** — 55,6-56,9% de acierto revirtiendo, 21 de 47 combinaciones pasan la corrección, aguanta los 3 controles (entrada demorada, precio alternativo, prueba ciega). Bloqueado por un dato que falta: el pago de plazos cortos, que el cron empieza a capturar pasadas las 00:00 UTC. Necesita 79,8% para empatar |
